        ...
        activeModal(val) {
            ...
            switch (val) {
                ...
                case 'edit_metas_modal':
                    ...
                    if (typeof this.selectedFile.metas.localizedMetas === 'undefined') {
                      this.selectedFile.metas.localizedMetas = {};
                    }
                    this.config.locales.forEach(locale => {
                      if (typeof this.selectedFile.metas.localizedMetas[locale] === 'undefined') {
                        this.selectedFile.metas.localizedMetas[locale] = {
                          title: '',
                          alt: '',
                          description: '',
                        };
                    ...
                    this.localizedMetas = this.selectedFile.metas.localizedMetas;

...
use Adeliom\SyliusHappyCMSPlugin\Twig\Seo\SeoExtension;
...
final class SeoCollector extends AbstractDataCollector
{
    ...
    private function getTitleStatusClass(int $size): string
    {
        ...
        return $size >= SeoExtension::MIN_TITLE_LENGTH && $size <= SeoExtension::MAX_TITLE_LENGTH ? self::METRIC_CLASS_OK : self::METRIC_CLASS_WARNING;
    }
    ...
    private function getDescriptionStatusClass(int $size): string
    {
        ...
        return $size >= SeoExtension::MIN_DESCRITION_LENGTH && $size <= SeoExtension::MAX_DESCRITION_LENGTH ? self::METRIC_CLASS_OK : self::METRIC_CLASS_WARNING;
    }
